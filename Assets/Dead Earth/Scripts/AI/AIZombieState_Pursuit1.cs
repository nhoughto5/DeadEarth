...
public class AIZombieState_Pursuit1 : AIZombieState
{
    ...
    public override AIStateType OnUpdate()
    {
        ...
        if (!_zombieStateMachine.useRootRotation && _zombieStateMachine.targetType == AITargetType.Visual_Player && _zombieStateMachine.VisualThreat.type == AITargetType.Visual_Player && _targetReached)
        {
